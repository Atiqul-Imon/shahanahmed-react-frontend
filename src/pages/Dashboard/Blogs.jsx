...
import { fetchDataFromApi, deleteBlog } from '../../../utils/api';
            ...
            <div className="bg-white p-8 rounded-2xl shadow-soft border border-gray-200">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">You have {blogs.length} blogs.</p>
                    </div>
                    <button
                ...
                <div className="flex items-center space-x-4 mb-6">
                    <div className="relative flex-grow">
                        ...
                        <input type="text" placeholder="Search blogs..." className="w-full pl-11 input-field" />
                    </div>
                </div>
                            ...
                            {loading ? (
                                ...
                                blogs.map((blog) => (
                                    <tr key={blog._id} className="border-b border-gray-100 hover:bg-gray-50">
                                        ...
                                        <td className="p-4 align-top">
                                            <span className="badge-primary">{blog.categories?.join(', ') || 'N/A'}</span>
                                        </td>
                                        ...
                                        <td className="p-4 text-center align-top">
                                            <div className="flex items-center justify-center space-x-2">
                                                <button onClick={() => navigate(`/dashboard/edit-blog/${blog._id}`)} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg">
                                                    <Edit size={16} />
                                                </button>
